  ...
  async onGridReady(params, thisProps) {
    ...
    var dataSource = {
      ...
      getRows: async function (params) {
        ...
        var dataAfterSortingAndFiltering = data.users;
        console.log(dataAfterSortingAndFiltering);
        // sortData(
        ...
        } else if (data.count >= params.endRow) {
          lastRow = data.count;
        } else {
          lastRow = -1;
        }
        params.successCallback(dataAfterSortingAndFiltering, data.count);
      },
    };
